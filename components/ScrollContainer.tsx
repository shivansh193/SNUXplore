    ...
    return (
        <div className={'h-screen w-full bg-white flex flex-row'}>
            <div className={'h-full w-1/3 bg-snuxplore-brown flex flex-col px-8 pt-8 justify-start items-center'}>
                <div className={`w-full h-fit text-3xl text-white flex flex-row items-center transition-transform duration-300 ${showHeader ? 'translate-y-0' : '-translate-y-full'}`}>
                    <img src={"/s.svg"} className={'mr-2'} />SNUXplore
                </div>
                <div className={`w-full h-fit text-3xl font-semibold mt-8 text-snuxplore-yellow transition-transform duration-300 ${showHeader ? 'translate-y-0' : '-translate-y-full'}`}>Navigate Campus</div>
                ...
                <div className={`mt-8 w-full transition-transform duration-300 ${showHeader ? 'translate-y-0' : '-translate-y-full'}`}>
